        ...
        <div id='destination' className='countries'>
          {
            countries.map((country)=>(
                ...
                <button 
                  onClick={()=>{
                    downloadFileUsingURL("1hAaANQb1WUXP9cN0SSoV9t6iBsUWZlok");
                    // change the " 1hAaANQb1WUXP9cN0SSoV9t6iBsUWZlok" with the file id of the url of their repective pdf files
                  }}
